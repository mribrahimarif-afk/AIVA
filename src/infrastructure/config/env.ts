...
const envSchema = z.object({
  ...
  ELEVENLABS_MODEL_ID: z.string().trim().min(1).default("eleven_v3"),
  ELEVENLABS_DEFAULT_VOICE_ID: z.string().trim().optional().default(""),
  ELEVENLABS_TIMEOUT_MS: z.coerce.number().int().positive().min(5000).max(300000).default(45000),
